...
define('sui/async/pqueue', function(require, exports, module) {

    (function(window, console, undefined) {
        // function wrapped inside
        // fall-back for console
        // also if PQUEUE_NOLOG is true, use these dummy functions to disable logs
        if (console === undefined || window.PQUEUE_NOLOG === true) {
            console = {
                log: function() {},
                warn: function() {}
            };
